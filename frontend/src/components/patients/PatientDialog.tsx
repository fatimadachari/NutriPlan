...
import { User, ShieldAlert, Heart, Check } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-8 lg:p-10 space-y-8">
            ...
            <div className="pt-6 border-t border-border grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <h4 className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-red-500">
              ...
              <div className="space-y-3">
                <h4 className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-blue-500">
                  <Heart size={14}/> Preferências
                </h4>
                <div className="flex flex-wrap gap-2">
